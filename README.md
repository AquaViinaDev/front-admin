...
``` bash
# dev server with hot reload at http://157.90.240.22:3000
$ npm start 
```
...
Navigate to [http://157.90.240.22:3000](http://157.90.240.22:3000). The app will automatically reload if you change any of the source files.
